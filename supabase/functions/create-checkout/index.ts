...
serve(async (req) => {
  ...
  try {
    ...
    if (customers.data.length > 0) {
      ...
      console.log("[CREATE-CHECKOUT] No existing customer");
    }

    const origin = req.headers.get("origin") || "https://iccxtssdximiuarmnbmx.supabase.co";
    ...
    const errorMessage = error instanceof Error ? "Payment initialization failed" : "Unknown error";
