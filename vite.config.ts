...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      injectRegister: null, // Completely disable registerSW.js to avoid render-blocking
  ...
  build: {
    ...
    // Optimize chunk size for better FCP
    chunkSizeWarningLimit: 600,
    minify: "terser",
    terserOptions: {
      compress: {
        drop_debugger: true,
        pure_funcs: ['console.log'], // Remove console.log but keep console.error/warn
      },
    },
  },
}));
