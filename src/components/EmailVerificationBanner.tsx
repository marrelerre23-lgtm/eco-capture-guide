...
export const EmailVerificationBanner = () => {
  ...
  return (
    <div className="fixed top-16 left-0 right-0 z-40 p-4 animate-in slide-in-from-top-5">
      <div
        role="alert"
        className="relative w-full rounded-lg border border-amber-500 bg-amber-500/10 p-4 flex items-center gap-4"
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Button onClick={handleResendEmail} disabled={isSending} size="sm" variant="default">
            {isSending ? (
              <>
